...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
       ...
       <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,600;1,400&display=swap" rel="stylesheet">
        ...
        .text-shadow-bold {
  text-shadow:
    0.5px 0 0 #000, /* Menor desplazamiento horizontal */
    0 0.5px 0 #000, /* Menor desplazamiento vertical */
    -0.5px 0 0 #000,
    0 -0.5px 0 #000;
}
        ...
        <template x-for="(slide, index) in slides" :key="index">
            ...
            <section id="Reseñas" class="py-16 bg-[#f5ffff]">
                <div class="container mx-auto px-4">
                    ...
                    >
                        <h2 class="text-4xl md:text-5xl text-gray-800 mr-4 mb-2 md:mb-0 poppins-bold text-shadow-bold">Tu Experiencia Con</h2>
                        <img
                            src="/svg/NH.svg"
            ...
            <section id="Noticias" class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <h2 class="text-4xl md:text-5xl text-gray-900 text-center mb-12 animate-fade-in-up poppins-bold text-shadow-bold">
                    ...
                    <div x-data="{ showAllNews: false }">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div class="bg-white rounded-lg shadow-xl overflow-hidden animate-slide-in-bottom delay-300">
                                ...
                                <div class="p-6">
                                    <h3 class="text-2xl font-bold text-gray-900 mb-3 poppins-bold">Gastronomía Peruana: Un Viaje de Sabores</h3>
                                    <p class="text-gray-700 leading-relaxed">
