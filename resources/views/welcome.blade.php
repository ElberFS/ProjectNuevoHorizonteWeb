...
>
    ...
    <div class="container mx-auto px-4">
        <h2 class="text-4xl text-center text-black mb-8 poppins-bold text-shadow-bold">Aliados Estratégicos</h2>
        ...
        <div
            x-data="{
                ...
                categories: {
                    'aerolineas': [
                        { src: '/img/aereolineas/Logo1.png', alt: 'Aerolinea 1' },
                        { src: '/img/aereolineas/Logo2.svg', alt: 'Aerolinea 2' },
                        { src: '/img/aereolineas/Logo3.png', alt: 'Aerolinea 3' },
                        { src: '/img/aereolineas/Logo4.svg', alt: 'Aerolinea 4' },
                        { src: '/img/aereolineas/Logo5.svg', alt: 'Aerolinea 5' },
                        { src: '/img/aereolineas/Logo6.png', alt: 'Aerolinea 6' },
                        // Duplicamos para que el carrusel tenga más elementos para desplazar
                    ],
                    'hoteles': [
                        // Usaremos algunas imágenes existentes para simular logos de hoteles
                        { src: '/img/Hoteles/Logo1.png', alt: 'Hotel 1' },
                        { src: '/img/Hoteles/Logo2.png', alt: 'Hotel 2' },
                        { src: '/img/Hoteles/Logo3.jpg', alt: 'Hotel 3' },
                        { src: '/img/Hoteles/Logo4.svg', alt: 'Hotel 4' },
                        { src: '/img/Hoteles/Logo5.png', alt: 'Hotel 5' },
                        { src: '/img/Hoteles/Logo6.png', alt: 'Hotel 6' },
                        { src: '/img/Hoteles/Logo7.png', alt: 'Hotel 7' },
                    ],
                    'Operadores de destino': [ // Una nueva categoría de ejemplo
                        { src: '/img/Operadores/Logo1.svg', alt: 'Turismo 1' },
                        { src: '/img/Operadores/Logo2.png', alt: 'Turismo 2' },
                        { src: '/img/Operadores/Logo3.png', alt: 'Turismo 3' },
                        { src: '/img/Operadores/Logo4.png', alt: 'Turismo 4' },
                        { src: '/img/Operadores/Logo5.png', alt: 'Turismo 5' },
                        { src: '/img/Operadores/Logo6.png', alt: 'Turismo 6' },
                        { src: '/img/Operadores/Logo7.svg', alt: 'Turismo 7' },
                    ],
                    'Marca De Pais': [ // Una nueva categoría de ejemplo
                        { src: '/img/Marca/Logo1.svg', alt: 'Marca De Pais 1' },
                        { src: '/img/Marca/Logo2.svg', alt: 'Marca De Pais 2' },
                        { src: '/img/Marca/Logo3.svg', alt: 'Marca De Pais 3' },
                        { src: '/img/Marca/Logo4.svg', alt: 'Marca De Pais 4' },
                        { src: '/img/Marca/Logo5.png', alt: 'Marca De Pais 5' },
                        { src: '/img/Marca/Logo6.png', alt: 'Marca De Pais 6' },
                        { src: '/img/Marca/Logo7.svg', alt: 'Marca De Pais 7' },
                    ],
                },
                currentCategory: 'aerolineas', // Categoría inicialmente seleccionada
                currentIndex: 0, // Índice actual del carrusel
                itemsPerPage: 5, // Cuántas imágenes se muestran a la vez
                autoAdvanceInterval: null, // Para el temporizador de avance automático

                // Propiedad computada para obtener las imágenes de la categoría actual
                get currentImages() {
                    return this.categories[this.currentCategory] || [];
                },

                // Propiedad computada para las imágenes que se mostrarán en el carrusel
                get carouselItems() {
                    const images = this.currentImages;
                    if (images.length === 0) return [];

                    // Creamos una lista 'cíclica' de imágenes para simular un carrusel infinito
                    let visible = [];
                    for (let i = 0; i < this.itemsPerPage; i++) {
                        visible.push(images[(this.currentIndex + i) % images.length]);
                    }
                    return visible;
                },
                ...
                next() {
                    ...
                    this.resetAutoAdvance(); // Reinicia el temporizador al interactuar
                },
                ...
                setCategory(category) {
                    if (this.categories[category]) {
                        ...
                        this.currentIndex = 0; // Reinicia el índice al cambiar de categoría
                        this.resetAutoAdvance(); // Reinicia el temporizador
                    }
                },

                // Inicia el avance automático del carrusel
                startAutoAdvance() {
                    this.stopAutoAdvance(); // Asegura que no haya múltiples intervalos
                ...
                // Reinicia el temporizador de avance automático (útil después de interacción manual o cambio de categoría)
                resetAutoAdvance() {
        ...
        >
            ...
            <div class="flex justify-center gap-4 mb-8">
                <template x-for="(images, key) in categories" :key="key">
                    <button
                        @click="setCategory(key)"
                        :class="{ 'bg-blue-600 text-white shadow-lg': currentCategory === key, 'bg-gray-200 text-gray-700 hover:bg-gray-300': currentCategory !== key }"
                        class="px-6 py-2 rounded-full font-bold transition-all duration-300 capitalize"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 transition-transform duration-500 ease-in-out">
                <template x-for="(image, index) in carouselItems" :key="index">
                    <div class="bg-white p-4 flex items-center justify-center rounded-lg ">
                        <img :src="image.src" :alt="image.alt" class="max-h-20 object-contain mx-auto">
                    </div>
                </template>
            </div>
            ...
            <section id="Reseñas" class="py-16 bg-[#f5ffff]">
                <div class="container mx-auto px-4">
                    ...
                    >
                        <h2 class="text-4xl text-gray-800 mr-4 mb-2 md:mb-0 poppins-bold text-shadow-bold">Tu Experiencia Con</h2>
                        <img
                            src="/svg/NH.svg"
            ...
            <section id="Noticias" class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <h2 class="text-4xl text-gray-900 text-center mb-12 animate-fade-in-up poppins-bold xt-shadow-bold">
                    ...
                    <div x-data="{ showAllNews: false }">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div class="bg-white rounded-lg shadow-xl overflow-hidden animate-slide-in-bottom delay-100">
                                ...
                                <div class="p-6">
                                    <h3 class="text-2xl text-gray-900 mb-3 poppins-bold">Descubre los Secretos Incas</h3>
                            ...
                            <div class="bg-white rounded-lg shadow-xl overflow-hidden animate-slide-in-bottom delay-200">
                                ...
                                <div class="p-6">
                                    <h3 class="text-2xl text-gray-900 mb-3 poppins-bold">Aventura Amazónica: Selva Peruana</h3>
                                    <p class="text-gray-700 leading-relaxed">
                            ...
                            <div class="bg-white rounded-lg shadow-xl overflow-hidden animate-slide-in-bottom delay-300">
                                ...
                                <div class="p-6">
                                    <h3 class="text-2xl text-gray-900 mb-3 poppins-bold">Gastronomía Peruana: Un Viaje de Sabores</h3>
                                    <p class="text-gray-700 leading-relaxed">
                            ...
                            <template x-if="showAllNews">
                                <div class="contents"> <div class="bg-white rounded-lg shadow-xl overflow-hidden animate-slide-in-bottom"
                                        ...
                                        <div class="p-6">
                                            ...
                                            <p class="text-gray-700 leading-relaxed">
                                                Sumérgete en las vibrantes festividades de Perú, donde las tradiciones ancestrales cobran vida with danzas, música y coloridos trajes. Descubre la riqueza cultural de nuestro país.
                                            </p>
                                        </div>
                                    </div>
            ...
            <section
                ...
                <div class="container mx-auto flex  md:flex-row items-center justify-center md:gap-4 gap-8">
                    ...
                    <div class="w-full md:w-[45%] flex flex-col items-center text-center md:items-start md:text-left animate-slide-in-right ">
                        <h2 class="text-4xl font-bold text-gray-800 mb-4 poppins-bold">¡Suscríbete!</h2>
        ...
        <footer  id="Contacto" class="bg-[#163E73] text-white py-16 px-4 animate-fade-in">
            <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
                <div class="text-center md:text-left">
                    ...
                    <p class="text-gray-300 text-2xl leading-snug poppins-bold">Aliados Contigo</p>
                    <p class="text-gray-300 text-2xl leading-snug poppins-bold">Nuestra experiencia, siempre a tu lado!</p>
                </div>

                <div class="text-center md:text-left">
                    <h3 class="text-white text-xl mb-4 uppercase poppins-bold">Politicas</h3>
                    <ul class="space-y-2">
                ...
                <div class="text-center md:text-left">
                    <h3 class="text-white text-xl mb-4 uppercase poppins-bold">Atencion al Cliente</h3>
                    <ul class="space-y-2">
