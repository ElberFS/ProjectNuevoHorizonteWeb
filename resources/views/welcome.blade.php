    ...
    <div class="container mx-auto px-4">
        ...
        <div
            x-data="{
                ...
                categories: {
                    'aerolineas': [
                        { src: '/img/alianzas/Logo1.png', alt: 'Aerolinea 1' },
                        { src: '/img/alianzas/Logo2.png', alt: 'Aerolinea 2' },
                        { src: '/img/alianzas/Logo3.png', alt: 'Aerolinea 3' },
                        { src: '/img/alianzas/Logo4.png', alt: 'Aerolinea 4' },
                        { src: '/img/Marca/Logo4.svg', alt: 'Aerolinea 5' },
                        // Duplicamos para que el carrusel tenga más elementos para desplazar
                        { src: '/img/alianzas/Logo1.png', alt: 'Aerolinea 6' },
                        { src: '/img/alianzas/Logo2.png', alt: 'Aerolinea 7' },
                        { src: '/img/alianzas/Logo3.png', alt: 'Aerolinea 8' },
                    ],
                    'hoteles': [
                        // Usaremos algunas imágenes existentes para simular logos de hoteles
                        { src: '/img/alianzas/Logo3.png', alt: 'Hotel 1' },
                        { src: '/img/alianzas/Logo4.png', alt: 'Hotel 2' },
                        { src: '/img/Marca/Logo4.svg', alt: 'Hotel 3' },
                        { src: '/img/alianzas/Logo1.png', alt: 'Hotel 4' },
                        { src: '/img/alianzas/Logo2.png', alt: 'Hotel 5' },
                        { src: '/img/alianzas/Logo3.png', alt: 'Hotel 6' },
                        { src: '/img/alianzas/Logo4.png', alt: 'Hotel 7' },
                    ],
                    'turismo': [ // Una nueva categoría de ejemplo
                        { src: '/img/alianzas/Logo4.png', alt: 'Turismo 1' },
                        { src: '/img/Marca/Logo4.svg', alt: 'Turismo 2' },
                        { src: '/img/alianzas/Logo1.png', alt: 'Turismo 3' },
                        { src: '/img/alianzas/Logo2.png', alt: 'Turismo 4' },
                        { src: '/img/alianzas/Logo3.png', alt: 'Turismo 5' },
                        { src: '/img/alianzas/Logo4.png', alt: 'Turismo 6' },
                        { src: '/img/Marca/Logo4.svg', alt: 'Turismo 7' },
                    ],
                },
